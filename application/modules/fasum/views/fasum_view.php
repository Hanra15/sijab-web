            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- <a href="<?= base_url() ?>fasum/Kategori" class="btn btn-success mt-3 mb-3">
                ...
                <form action="" method="post" id="form_tambah" class="form row g-3 needs-validation" enctype="multipart/form-data" novalidate>
                    <div class="col-md-6">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="test" required>
                            <label for="nama" class="col-form-label">Nama Fasilitas</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="kategori" class="col-form-label">Kategori Fasilitas</label>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        <label for="mapTambah" class="col-form-label">Lokasi Fasilitas</label>
...
<script>
    $(document).ready(function() {
        ...
        // init fetch data
        var fetchData = fetch("<?= base_url() ?>fasum/serverSideTable").then(
        ...
        $(".form").submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>fasum/Fasum/tambah",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
    ...
    $('#btnTambah').on('click', function(e) {
        $('#form_tambah')[0].reset()
        // document.getElementById("namaFasilitas").removeAttribute('disabled');
    ...
    $(document).ready(function() {
        ...
        var initialZoom = 12;
        // layers
        var OpenStreetMap = L.gridLayer.googleMutant({
            maxZoom: 24,
            type: "roadmap",
